...
.
 ...
 | [Advertisement Block List](uploads/hosts) | This list conatins a root file `/etc/hosts` exclusively with `Debian` for blocking the `Advertisement` `Domain list` including `GAFAM`
